    ...
    <div v-if="modelValue"
      ...
      <section class="my-4">
        <div id="modal-js-example"
          ...
          <div class="max-h-fit relative flex flex-col w-full md:my-0 md:mx-auto max-w-screen-md overflow-visible">
            <section v-if="showHeader" class="p-5 bg-white grow shrink overflow-auto">
              <slot name="header">
                <header class="p-2 text-left border-b border-b-primary-500 flex items-center justify-between">
                  <h3 id="modal-title text-left" class="font-bold text-primary-500 text-xl">
                    {{ title }}
                  </h3>
