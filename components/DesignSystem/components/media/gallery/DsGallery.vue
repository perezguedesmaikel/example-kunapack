...
import type { IGalleryData } from "~/components/DesignSystem/components/media/gallery/interfaces";
...
import { useImageGallery } from "~/components/DesignSystem/composables/useImageGallery";
import { ref } from "vue";
  ...
  <div :class="['relative p-2', filterClassComp]">
    ...
    >
      ...
      <template #footer>
        ...
        >
          <DsIcon aria-hidden="true" imageOrAwesome="angle-left" />
        ...
        <button
          ...
          @click="goToNextImage"
        >
          <DsIcon aria-hidden="true" imageOrAwesome="angle-right" />
