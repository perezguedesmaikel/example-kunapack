...
import type { IMenuItem } from "~/components/DesignSystem/components/navigation/topMenu/interfaces";
          ...
          >
            ...
            >
              <template v-for="item2 in item1.items">
                ...
                >
                  <DsIcon imageOrAwesome="angle-right" size="base" />
                  {{ item2.text }}
                </button>
                ...
                <div v-if="item2.items" class="relative">
                  ...
                  <div v-if="item2.open" id="accordionMenu" class="dropdownlv2">
                    ...
                    >
                      ...
                      >
                        <DsIcon imageOrAwesome="arrow-right" size="base" />
                        {{ item3.text }}
                      </button>
                    </div>
                  </div>
